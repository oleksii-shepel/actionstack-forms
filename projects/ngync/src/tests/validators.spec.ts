...
describe('Validators', () => {
  ...
  describe('required', () => {
    it('should error on an empty string', () => {
      expect(Validators.required(new FormControl(''))).toEqual({
        required: true,
      });
    });

    it('should error on null', () => {
      expect(Validators.required(new FormControl(null))).toEqual({
        required: true,
      });
    });

    it('should not error on undefined', () => {
      expect(Validators.required(new FormControl(undefined))).toEqual({
        required: true,
      });
    });
    ...
    it('should not error on an object containing a length attribute that is zero', () => {
      expect(
        Validators.required(new FormControl({ id: 1, length: 0, width: 0 }))
      ).toBeNull();
    });
  });
  ...
  describe('requiredTrue', () => {
    it('should error on false', () =>
      expect(Validators.requiredTrue(new FormControl(false))).toEqual({
        required: true,
      }));
  ...
  describe('email', () => {
    ...
    it('should error on invalid email', () =>
      expect(Validators.email(new FormControl('some text'))).toEqual({
        email: true,
      }));
  ...
  describe('pattern', () => {
    ...
    it('should not error on null', () => {
      expect(
        Validators.pattern('[a-zA-Z ]+')(new FormControl(null))
      ).toBeNull();
    });

    it('should not error on undefined', () => {
      expect(
        Validators.pattern('[a-zA-Z ]+')(new FormControl(undefined))
      ).toBeNull();
    });
    ...
    it('should not error on valid strings', () =>
      expect(
        Validators.pattern('[a-zA-Z ]*')(new FormControl('aaAA'))
      ).toBeNull());
    ...
    it('should not error on "undefined" pattern', () =>
      expect(
        Validators.pattern(undefined!)(new FormControl('aaAA'))
      ).toBeNull());

    it('should work with pattern string containing both boundary symbols', () =>
      expect(
        Validators.pattern('^[aA]*$')(new FormControl('aaAA'))
      ).toBeNull());
